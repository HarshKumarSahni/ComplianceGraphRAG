      ...
      >
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-white mb-2">
            Welcome to GraphGuard AI
          </h1>
          <p className="text-sm text-slate-400 max-w-sm">
            Enterprise Compliance Multi-Modal GraphRAG Platform
          </p>
        </div>
        ...
        <div className="w-full bg-[#0F172A]/80 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-cyan-950/20">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className="w-full py-3.5 px-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 font-bold rounded-xl shadow-lg shadow-cyan-500/25 transition-all duration-200 flex items-center justify-center gap-2 text-sm disabled:opacity-50 cursor-pointer mt-2"
            >
              {isSubmitting ? (
                <>
