...
import { Network, Filter, RotateCcw, Layers, X, Shield, Server, Database, AlertTriangle } from 'lucide-react';
...
const nodeColorMap: Record<string, { bg: string; border: string; text: string; iconBg: string }> = {
  Regulation: { bg: '#eff6ff', border: '#3b82f6', text: '#1d4ed8', iconBg: '#dbeafe' },
  Policy: { bg: '#eff6ff', border: '#3b82f6', text: '#1d4ed8', iconBg: '#dbeafe' },
  Application: { bg: '#eef2ff', border: '#6366f1', text: '#4338ca', iconBg: '#e0e7ff' },
  Storage: { bg: '#ecfdf5', border: '#10b981', text: '#047857', iconBg: '#d1fae5' },
  'Cloud Service': { bg: '#ecfdf5', border: '#10b981', text: '#047857', iconBg: '#d1fae5' },
  'Data Asset': { bg: '#ecfdf5', border: '#10b981', text: '#047857', iconBg: '#d1fae5' },
  'Compliance Rule': { bg: '#fffbe finished', border: '#f59e0b', text: '#b45309', iconBg: '#fef3c7' },
  Risk: { bg: '#fff1f2', border: '#f43f5e', text: '#be123c', iconBg: '#ffe4e6' },
};
...
export default function GraphPage() {
  ...
  // Convert raw nodes to React Flow nodes with circular layout
  ...
  return (
    <div className="space-y-6 h-[calc(100vh-7rem)] flex flex-col">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 flex-1 min-h-0">
        ...
        <Card className="lg:col-span-1 flex flex-col min-h-0">
          <CardHeader className="py-4 border-b border-slate-100 dark:border-slate-800/60">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-sm">Filter Graph Entities</CardTitle>
            </div>
          </CardHeader>
        ...
        <Card className="lg:col-span-3 flex flex-col relative overflow-hidden">
          {isLoading ? (
            ...
            <div className="flex-1 w-full h-full relative">
              ...
              {/* Node Detail Inspector Card overlay */}
              {selectedNode && (
